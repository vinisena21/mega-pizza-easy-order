...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Mega Pizza — Delivery Premium de pizzas artesanais" },
      {
        name: "description",
        content:
          "Pizzas artesanais com massa de fermentação natural. Peça online e receba quentinho na sua casa.",
      },
      { name: "theme-color", content: "#1a0e0e" },
      { property: "og:type", content: "website" },
      { property: "og:site_name", content: "Mega Pizza" },
      { property: "og:title", content: "Mega Pizza — Delivery Premium de pizzas artesanais" },
      { name: "twitter:title", content: "Mega Pizza — Delivery Premium de pizzas artesanais" },
      { name: "description", content: "Mega Pizza Delivery is a full-stack online platform for a pizza delivery business." },
      { property: "og:description", content: "Mega Pizza Delivery is a full-stack online platform for a pizza delivery business." },
      { name: "twitter:description", content: "Mega Pizza Delivery is a full-stack online platform for a pizza delivery business." },
